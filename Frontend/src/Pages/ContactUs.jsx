...
const ContactUs = () => {
  return (
    <>
      <div>
        <section className="bg-slate-200 text-black md:h-screen" id="contact">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div className="mb-4">
              <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <h2 className="font-heading mb-4 font-bold tracking-tight  text-blue-500 text-3xl sm:text-5xl">
                  Contact Us
                </h2>
              </div>
            </div>
                  ...
                  <ul className="mb-6 md:mb-0">
                    ...
                    <li className="flex">
                      ...
                      <div className="ml-4 mb-4">
                        ...
                        <p className="text-gray-600 ">
                          Mobile : +91 7387 5171 50
                        </p>
                        <p className="text-gray-600 ">
                          Mail : abhishekkank5@gmail.com
                        </p>
                      </div>
                    </li>
                    <li className="flex">
